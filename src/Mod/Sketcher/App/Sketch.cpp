                                ...
                                const std::vector<Constraint*>& ConstraintList) const
{
    ...
    for (auto& constr : ConstraintList) {
        ...
        std::array<bool, 3> isConstraintBeforeBlock {
            !isGeomExternal[0] && isConstraintBeforeBlock[constr->First],
            !isGeomExternal[1] && isConstraintBeforeBlock[constr->Second],
            !isGeomExternal[2] && isConstraintBeforeBlock[constr->Third]};
